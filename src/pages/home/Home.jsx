  ...
  return (
    <main>
      ...
      <section className="w-full flex items-center justify-center">
        <Link to="/donate" className="rounded-[4px] my-[20px]  border-[3px] border-[#008374] px-[20px] py-[5px] flex items-center text-[#008374] text-[30px] font-bold  hover:text-white hover:bg-[#008374]" style={{
